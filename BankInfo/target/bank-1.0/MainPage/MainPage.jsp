         ...
         <% for (int i = 0; i <list.size() ; i++) {%>
          <div class="row">
            ...
            <div class="bank-info col-md-10">
              ...
              <!--Button deposits-->
  <button type="button" class="btn btn-depos btn-primary buttonOne">Список депозитов</button>
              <br>
              <!--Block Deposits-->
              <div class="deposits-block depBlockOne">
    ...
    <script type="text/javascript" src="MainPage/javascript_mainpage.js"></script>
  </body>
</html>