...
public class DepositDaoMock implements DepositDao{
    ...
    public DepositDaoMock(){
       ...
       //SrochniyB
        ...
        //SrochniyС
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",61,"hryvna",12.0,12,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",62,"hryvna",12.0,6,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",63,"hryvna",11.25,3,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",64,"dollar",2.75,12,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",65,"dollar",2.25,6,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",66,"dollar",1.25,3,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",67,"euro",0.75,12,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",68,"euro",0.25,6,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, в конце срока)",69,"euro",0.01,3,"В конце срока",true,false));
        //SrochniyD
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",70,"hryvna",11.0,12,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",71,"hryvna",11.0,6,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",72,"hryvna",10.25,3,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",73,"dollar",2.25,12,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",74,"dollar",1.75,6,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",75,"dollar",0.75,3,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",76,"euro",0.25,12,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",77,"euro",0.1,6,"В конце срока",true,false));
        memory.add(new Deposit("Срочный(с возможностью досрочного закрытия, Ежемесячно)",78,"euro",0.1,3,"В конце срока",true,false));
        //Ощадний рахунок
